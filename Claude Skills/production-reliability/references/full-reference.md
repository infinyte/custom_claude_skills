# Release It! — Full Reference Tier

**Attribution:** This file is the `full` tier from the `release-it` rule set in the
[agent-rules-books](https://github.com/ciembor/agent-rules-books) project by Maciej
Ciemborowicz (MIT licensed), itself a distillation of Michael T. Nygard's *Release It!*. It is
